      ...
      <main id="top">
        <section className="hero">
          <div className="hero-copy">
            <span className="eyebrow">Premium IT services & computer spares</span>
            <h1>VKP Technologies</h1>
            <p>Fast laptop service, CCTV installation, networking, servers, firewalls, printers, business hardware, websites, SEO, billing automation, and dealer-ready bulk ordering in Coimbatore.</p>
            <div className="hero-actions">
              <a className="primary-btn" href="#bulk">Bulk Inquiry <ChevronRight size={18} /></a>
              <a className="secondary-btn" href="#contact">Contact Us <Phone size={18} /></a>
            </div>
            <div className="trust-row">
              <span><CheckCircle2 size={17} /> Fast Service</span>
              <span><ShieldCheck size={17} /> Quality Guaranteed</span>
              <span><Truck size={17} /> Quick Delivery</span>
            </div>
          </div>
